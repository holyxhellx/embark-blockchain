...
<head>
  ...
  <title>Extending functionality with plugins &mdash; Embark 2.2.1 documentation</title>
...
<h1>Extending functionality with plugins<a class="headerlink" href="#extending-functionality-with-plugins" title="Permalink to this headline">¶</a></h1>
...
<p><strong>embark.registerCompiler(extension, callback(options))</strong></p>
<p>expected return: <code class="docutils literal"><span class="pre">hash</span></code> of compiled contracts</p>
<blockquote>
<div><ul class="simple">
...
<span class="n">module</span><span class="o">.</span><span class="n">exports</span> <span class="o">=</span> <span class="n">function</span><span class="p">(</span><span class="n">embark</span><span class="p">)</span> <span class="p">{</span>
    <span class="n">embark</span><span class="o">.</span><span class="n">registerCompiler</span><span class="p">(</span><span class="s2">&quot;.sol&quot;</span><span class="p">,</span> <span class="n">function</span><span class="p">(</span><span class="n">contractFiles</span><span class="p">)</span> <span class="p">{</span>
      ...
      <span class="k">return</span> <span class="n">compiled_object</span><span class="p">;</span>
    <span class="p">});</span>
<span class="p">}</span>
</pre></div>
</div>
